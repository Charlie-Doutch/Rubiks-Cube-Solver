...
class Blocks:
    def __init__(self):
        ...
        self.blocks = [
            ...
            # Blue Side
            Block(517, 220, 50, 50, 'Orange', self.block_colours),
            Block(572, 220, 50, 50, 'Orange', self.block_colours),
            Block(627, 220, 50, 50, 'Orange', self.block_colours),
            Block(517, 275, 50, 50, 'Orange', self.block_colours),
            Block(627, 275, 50, 50, 'Orange', self.block_colours),
            Block(517, 330, 50, 50, 'Orange', self.block_colours),
            Block(572, 330, 50, 50, 'Orange', self.block_colours),
            Block(627, 330, 50, 50, 'Orange', self.block_colours),
            # Orange Side
            Block(687, 220, 50, 50, 'Blue', self.block_colours),
            Block(742, 220, 50, 50, 'Blue', self.block_colours),
            Block(797, 220, 50, 50, 'Blue', self.block_colours),
            Block(687, 275, 50, 50, 'Blue', self.block_colours),
            Block(797, 275, 50, 50, 'Blue', self.block_colours),
            Block(687, 330, 50, 50, 'Blue', self.block_colours),
            Block(742, 330, 50, 50, 'Blue', self.block_colours),
            Block(797, 330, 50, 50, 'Blue', self.block_colours),
            # Yellow Side
